            ...
            <div class="grid grid-cols-1 2xl:grid-cols-3 gap-4 pt-2">
              ...
              <div class="flex flex-col gap-2 min-w-0">
                ...
                <span v-if="v$.gButirosa.$invalid && submitted">
                  <small
                    class="text-red-500 block mb-1"
                    v-for="error of v$.gButirosa.$errors"
                    :key="error.$uid"
                  >
                    {{ error.$message }}
                  </small>
              ...
              <div class="flex flex-col gap-2 min-w-0">
                ...
                <span v-if="v$.ltDiarios.$invalid && submitted">
                  <small
                    class="text-red-500 block mb-1"
                    v-for="error of v$.ltDiarios.$errors"
                    :key="error.$uid"
                  >
                    {{ error.$message }}
                  </small>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div class="flex flex-col gap-2">
                ...
                <span v-if="v$.actVoluntaria.$invalid && submitted">
                  <small
                    class="text-red-500 block mb-1"
                    v-for="error of v$.actVoluntaria.$errors"
                    :key="error.$uid"
                  >
                    {{ error.$message }}
                  </small>
              ...
              <div class="flex flex-col gap-2">
                ...
                <span v-if="v$.actReproductiva.$invalid && submitted">
                  <small
                    class="text-red-500 block mb-1"
                    v-for="error of v$.actReproductiva.$errors"
                    :key="error.$uid"
                  >
                    {{ error.$message }}
                  </small>
            ...
            <div class="grid grid-cols-1 2xl:grid-cols-3 gap-4">
              ...
              <div class="flex flex-col gap-2">
                ...
                <span v-if="v$.dGestacion.$invalid && submitted">
                  <small
                    class="text-red-500 block mb-1"
                    v-for="error of v$.dGestacion.$errors"
                    :key="error.$uid"
                  >
                    {{ error.$message }}
                  </small>
      ...
      <template #content>
        <div class="flex flex-col gap-6 overflow-y-auto">
              ...
              <div class="flex-1 flex flex-col gap-2 min-w-48">
                <FloatLabel variant="on">
                  <AutoComplete
                    ...
                    :suggestions="alimentosSugeridos"
                    @complete="buscarAlimento"
                    field="nombre"
                    dropdown
                    id="alimento"
                    class="w-full"
                  ...
                  >
                    <template #option="slotProps">
                      <div class="flex flex-col">
                        ...
                        <div class="flex flex-row flex-wrap gap-x-3 text-sm text-gray-600">
                          <span>
                            {{ slotProps.option.grupo }}
                          </span>
          ...
          <DataTable
            ...
            dataKey="alimento.id"
          >
            <template #header> Ración de Alimentos </template>

            <Column
              field="alimento.nombre"
              header="Alimento"
              :sortable="true"
              style="min-width: 150px"
            ></Column>

            <Column field="mtc" header="MTC (kg)" :sortable="true" style="width: 10rem">
            ...
            <Column field="alimento.ms" header="MS %" style="width: 8rem"></Column>
            <Column field="alimento.pb" header="PB %" style="width: 8rem"></Column>
            <Column field="alimento.em" header="EM" style="width: 8rem"></Column>
            <Column field="alimento.calcio" header="Ca %" style="width: 8rem"></Column>
            <Column field="alimento.fosforo" header="P %" style="width: 8rem"></Column>
            <Column field="alimento.fdn" header="FDN %" style="width: 8rem"></Column>
            <Column field="alimento.precio" header="Precio" style="width: 8rem"></Column>
            ...
            ></Column>
            <Column header="Eliminar" style="width: 7rem" bodyStyle="text-align:center">
            ...
            <ColumnGroup type="footer">
              <Row>
                ...
                <Column :footer="resultados.sumaMtc ? round2(resultados.sumaMtc) : '0.00'" />
                <Column
                  :footer="resultados.sumaMs ? round2(resultados.sumaMs) : '0.00'"
                  footerHeader="MS Total (kg)"
                />
                <Column
                  :footer="resultados.sumaPb ? round2(resultados.sumaPb) : '0.00'"
                  footerHeader="PB Total (g)"
                />
                <Column
                  :footer="resultados.sumaEm ? round2(resultados.sumaEm) : '0.00'"
                  footerHeader="EM Total"
                />
                <Column
                  :footer="resultados.sumaCa ? round2(resultados.sumaCa) : '0.00'"
                  footerHeader="Ca Total (g)"
                />
                <Column
                  :footer="resultados.sumaP ? round2(resultados.sumaP) : '0.00'"
                  footerHeader="P Total (g)"
                />
                <Column
                  :footer="resultados.sumaFdn ? round2(resultados.sumaFdn) : '0.00'"
                  footerHeader="FDN Total %"
                />
                <Column
                  :footer="resultados.sumaCosto ? round2(resultados.sumaCosto) : '0.00'"
                  footerHeader="Costo Total"
                />
                <Column :colspan="2" />
              </Row>
            </ColumnGroup>

            <template #empty> Aún no se han añadido alimentos a la ración. </template>
          </DataTable>
        </div>
      </template>
    </Card>
          ...
          <div class="flex flex-col gap-6">
            <div class="border-t pt-4 flex flex-col sm:flex-row gap-2">
              <Button
                ...
                class="w-full sm:flex-1 p-button-lg"
              />
              <Button
                @click="limpiar"
                label="Limpiar"
            ...
            <Fieldset legend="Balances" :toggleable="false">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <FloatLabel variant="on">
                  <InputText
                    id="res-bal-pb"
                    :modelValue="mostrarValor(resultados.balancePb)"
                    :style="getBalanceStyle(resultados.balancePb)"
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-bal-em"
                    :modelValue="mostrarValor(resultados.balanceEm)"
                    :style="getBalanceStyle(resultados.balanceEm)"
                    class="w-full font-bold"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-bal-ca"
                    :modelValue="mostrarValor(resultados.balanceCa)"
                    :style="getBalanceStyle(resultados.balanceCa)"
                    class="w-full font-bold"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-bal-p"
                    :modelValue="mostrarValor(resultados.balanceP)"
                    :style="getBalanceStyle(resultados.balanceP)"
                    class="w-full font-bold"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-bal-fdn"
                    :modelValue="mostrarValor(resultados.balanceFdn)"
                    :style="getBalanceStyle(resultados.balanceFdn)"
                    class="w-full font-bold"
                    readonly
                  />
            ...
            <Fieldset legend="Aportes de la Ración">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-mtc"
                    :modelValue="mostrarValor(resultados.sumaMtc)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-ms"
                    :modelValue="mostrarValor(resultados.sumaMs)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-pb"
                    :modelValue="mostrarValor(resultados.sumaPb)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-em"
                    :modelValue="mostrarValor(resultados.sumaEm)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-ca"
                    :modelValue="mostrarValor(resultados.sumaCa)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-p"
                    :modelValue="mostrarValor(resultados.sumaP)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-fdn"
                    :modelValue="mostrarValor(resultados.sumaFdn)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-cap"
                    :modelValue="mostrarValor(resultados.caP)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-ap-costo"
                    :modelValue="mostrarValor(resultados.sumaCosto)"
                    class="w-full"
                    readonly
                  />
            ...
            <Fieldset legend="Requerimientos Lactancia">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-pb"
                    :modelValue="mostrarValor(resultados.totalPB)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-em"
                    :modelValue="mostrarValor(resultados.emTotal)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-em-aj"
                    :modelValue="mostrarValor(resultados.emAjustado)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-em-mov"
                    :modelValue="mostrarValor(resultados.emMov)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-em-rec"
                    :modelValue="mostrarValor(resultados.emRec)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-ca"
                    :modelValue="mostrarValor(resultados.ca)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-p"
                    :modelValue="mostrarValor(resultados.p)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-fdn"
                    :modelValue="mostrarValor(resultados.fdnTotal)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-ctms"
                    :modelValue="mostrarValor(resultados.ctmsPv)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-ctms-i"
                    :modelValue="mostrarValor(resultados.ctmsPvInicio)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-req-ctms-m"
                    :modelValue="mostrarValor(resultados.ctmsPvMitad)"
                    class="w-full"
                    readonly
                  />
            ...
            <Fieldset legend="Requerimientos Último Tercio Gestación">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
                <FloatLabel variant="on">
                  <InputText
                    id="res-utg-pb"
                    :modelValue="mostrarValor(resultados.utgPB)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-utg-em"
                    :modelValue="mostrarValor(resultados.utgEM)"
                    class="w-full"
                    readonly
                  />
                ...
                <FloatLabel variant="on">
                  <InputText
                    id="res-utg-ctms"
                    :modelValue="mostrarValor(resultados.ctmsPvUTG)"
                    class="w-full"
                    readonly
                  />
...
const rules = reactive({
  pVivo: {
    required: helpers.withMessage('El peso vivo es obligatorio', required),
    numeric: helpers.withMessage('El peso vivo debe ser un numero', numeric),
    minValue: withMessage('El peso vivo debe ser mayor o igual a 0', minValue(0)),
  },
  gButirosa: {
    required: helpers.withMessage('La grasa butirosa es obligatoria', required),
    numeric: helpers.withMessage('La grasa butirosa debe ser un numero', numeric),
    minValue: withMessage('La grasa butirosa debe ser mayor o igual a 0', minValue(0)),
  },
  ltDiarios: {
    required: helpers.withMessage('Los litros diarios son obligatorios', required),
    numeric: helpers.withMessage('Los litros diarios deben ser un numero', numeric),
    minValue: withMessage('Los litros diarios deben ser mayor o igual a 0', minValue(0)),
  },
  actVoluntaria: {
    required: helpers.withMessage('La actividad voluntaria es obligatoria', required),
    numeric: helpers.withMessage('La actividad voluntaria debe ser un numero', numeric),
    minValue: withMessage('La actividad voluntaria debe ser mayor o igual a 10', minValue(10)),
    maxValue: withMessage('La actividad voluntaria debe ser menor o igual a 40', maxValue(40)),
  },
  actReproductiva: {
    required: helpers.withMessage('La actividad reproductiva es obligatoria', required),
    numeric: helpers.withMessage('La actividad reproductiva debe ser un numero', numeric),
    minValue: withMessage('La actividad reproductiva debe ser mayor o igual a 0', minValue(0)),
  },
  pdpv: {
    required: helpers.withMessage('La pérdida diaria de peso vivo es obligatoria', required),
    numeric: helpers.withMessage('La pérdida diaria de peso vivo debe ser un numero', numeric),
    minValue: withMessage('La pérdida diaria de peso vivo debe ser mayor o igual a 0', minValue(0)),
  },
  gdpv: {
    required: helpers.withMessage('La ganancia diaria de peso vivo es obligatoria', required),
    numeric: helpers.withMessage('La ganancia diaria de peso vivo debe ser un numero', numeric),
    minValue: withMessage(
      'La ganancia diaria de peso vivo debe ser mayor o igual a 0',
      minValue(0),
    ),
  },
  penc: {
    required: helpers.withMessage('El peso de nacimiento de la cría es obligatorio', required),
    numeric: helpers.withMessage('El peso de nacimiento de la cría debe ser un numero', numeric),
    minValue: withMessage(
      'El peso de nacimiento de la cría debe ser mayor o igual a 0',
      minValue(0),
    ),
  },
  nc: {
    required: helpers.withMessage('El número de crías es obligatorio', required),
    numeric: helpers.withMessage('El número de crías debe ser un numero', numeric),
    minValue: withMessage('El número de crías debe ser mayor o igual a 0', minValue(0)),
  },
  dGestacion: {
    required: helpers.withMessage('Los días de gestación son obligatorios', required),
    numeric: helpers.withMessage('Los días de gestación deben ser un numero', numeric),
    minValue: withMessage('Los días de gestación deben ser mayor o igual a 0', minValue(0)),
  },
})
...
const agregarAlimento = () => {
  ...
  if (!alimentoSeleccionado.value || typeof alimentoSeleccionado.value !== 'object') {
    toast.add({
      severity: 'warn',
      summary: 'Error',
      detail: 'Debe seleccionar un alimento válido de la lista',
      life: 3000,
    })
    return
  }
  if (!mtcSeleccionado.value || mtcSeleccionado.value <= 0) {
    toast.add({
      severity: 'warn',
      summary: 'Error',
      detail: 'Debe ingresar una cantidad (MTC) positiva',
      life: 3000,
    })
    return
  }
  ...
  if (existe) {
    toast.add({
      ...
      summary: 'Duplicado',
      detail:
        'Ese alimento ya está en la ración. Puede editar la cantidad MTC directamente en la tabla.',
      life: 4000,
    })
    return
  }
...
function resetResultados() {
  ...
  toast.add({
    ...
    detail: 'Los resultados han sido reseteados. Presione "Calcular" para actualizar.',
    life: 4000,
  })
}
...
async function calcular() {
  ...
  const emMantAjust =
    emMant + (emMant * form.actVoluntaria) / 100 + (emMant * form.actReproductiva) / 100
  ...
  resultados.utgEM = round2(
    (-15.467 -
      1.1439 * form.penc +
      0.26316 * form.dGestacion -
      0.0021667 * form.nc -
      0.0010963 * form.dGestacion * form.dGestacion +
      0.011772 * form.penc * form.dGestacion -
      0.98352 * form.penc * form.nc +
      0.011735 * form.penc * form.dGestacion * form.nc) *
      0.239 +
      emMantAjust,
  )
  ...
  resultados.ctmsPvInicio = round2(
    ((165 + 368.6 * form.ltDiarios + 34.8 * form.pVivo ** 0.75) / 1000 / form.pVivo) * 100,
  )
  resultados.ctmsPvMitad = round2(
    ((533 + 305.2 * form.ltDiarios + 13.3 * form.pVivo) / 1000 / form.pVivo) * 100,
  )
  ...
  toast.add({
    ...
    detail: 'Resultados actualizados',
    life: 3000,
  })
}
